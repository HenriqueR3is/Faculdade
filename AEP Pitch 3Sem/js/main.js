...
//   let regionCounts =
//     JSON.parse(localStorage.getItem("regionCounts")) || Array(9).fill(0);
//   let energySourceCounts =
//     JSON.parse(localStorage.getItem("energySourceCounts")) ||
//     Array.from({ length: 9 }, () => ({
//       alternativo: 0,
...
//     for (let i = 0; i < 9; i++) {
//       document.getElementById(`region${i + 1}_alternativo`).textContent =
//         energySourceCounts[i].alternativo;
//       document.getElementById(`region${i + 1}_fontes_sustentavel`).textContent =
//         energySourceCounts[i].fontes_sustentavel;
//       document.getElementById(`region${i + 1}_nao_tem_energia`).textContent =
//         energySourceCounts[i].nao_tem_energia;
//       document.getElementById(
//         `region${i + 1}_comprada_com_companhia`
//       ).textContent = energySourceCounts[i].comprada_com_companhia;
//     }
//   }
...
//         "energySourceCounts",
//         JSON.stringify(energySourceCounts)
//       );
//     }
